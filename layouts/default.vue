...
<template>
  <div
    class="fixed top-0 left-0 w-full h-full lg:p-8
    bg-gradient-to-r
    from-orange-400 via-purple-500 to-green-500
    dark:from-pink-600 dark:via-purple-700 dark:to-blue-600
    poppins
    "
  >
    <div
      class="flex flex-col w-full h-full dark:bg-gray-900 bg-gray-100 lg:rounded-xl
